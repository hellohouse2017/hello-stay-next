                    ...
                    <Reveal>
                        <div className="grid-asym" style={{ marginBottom: "clamp(60px, 8vw, 100px)" }}>
                            ...
                            <div>
                                ...
                                <Link href={`${prefix}/hellohouse`} style={{ fontFamily: "var(--serif)", fontSize: "0.85rem", color: "#C8AD7F", letterSpacing: "0.1em", borderBottom: "1px solid rgba(200,173,127,0.3)", paddingBottom: "4px" }}>
                                    {t.home.explore_link}
                                </Link>
                            </div>
                        </div>
