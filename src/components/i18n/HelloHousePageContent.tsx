...
const rooms = {
    zh: [
        ...
        { floor: "2F", name: "1201 雙人房", sub: "標準舒適空間，溫馨的休憩角落。", size: "24 m²", highlight: "對外氣密窗", img: "/images/hellohouse/1201.jpg", imgAlt: "Hello Stay 你好哇寓所二樓 1201 溫馨雙人房，配置標準雙人床獨立筒床墊、簡約書桌椅、對外氣密窗與乾濕分離獨立衛浴。", amenities: ["🛏️ 標準雙人床", "💻 書桌", "📺 聯網電視", "❄️ 空調 / 吹風機"] },
        ...
        { floor: "4F", name: "1401 雙人房", sub: "雅緻高樓層視野，享受安靜的私人時光。", size: "24 m²", highlight: "對外落地窗", img: "/images/hellohouse/1401.jpg", imgAlt: "Hello Stay 你好哇寓所四樓 1401 雅緻雙人房，享有高樓層開闊視野與對外落地窗，房內設有精緻雙人沙發與茶几。", amenities: ["🛏️ 標準雙人床", "🪑 沙發 / 茶几", "📺 聯網電視", "❄️ 空調 / 吹風機"] },
    ...
    ja: [
        ...
        { floor: "2F", name: "1201 ダブルルーム", sub: "スタンダードな快適空間。", size: "24 m²", highlight: "気密窓", img: "/images/hellohouse/1201.jpg", imgAlt: "Hello House B&B 高雄 - 2F 1201ダブルルーム、快適なダブルベッド、エアコン、専用バスルーム完備。", amenities: ["🛏️ ダブルベッド", "💻 デスク", "📺 スマートTV", "❄️ エアコン / ドライヤー"] },
        ...
        { floor: "4F", name: "1401 ダブルルーム", sub: "上品な高層階ビュー。静かなプライベート空間。", size: "24 m²", highlight: "落地窓", img: "/images/hellohouse/1401.jpg", imgAlt: "Hello House B&B 高雄 - 4F 1401優雅なダブルルーム、高層階の窓からの街の景色とリラックス用ソファ。", amenities: ["🛏️ ダブルベッド", "🪑 ソファ / テーブル", "📺 スマートTV", "❄️ エアコン / ドライヤー"] },
    ...
    ko: [
        ...
        { floor: "2F", name: "1201 더블룸", sub: "편안한 스탠다드 객실.", size: "24 m²", highlight: "기밀창", img: "/images/hellohouse/1201.jpg", imgAlt: "Hello House B&B 가오슝 - 2F 1201 더블룸, 더블 침대, 에어컨 및 독립된 욕실 완비.", amenities: ["🛏️ 더블 침대", "💻 책상", "📺 스마트TV", "❄️ 에어컨 / 드라이어"] },
        ...
        { floor: "4F", name: "1401 더블룸", sub: "고층 전망의 우아한 프라이빗 공간.", size: "24 m²", highlight: "바닥~천장 창문", img: "/images/hellohouse/1401.jpg", imgAlt: "Hello House B&B 가오슝 - 4F 1401 우아한 더블룸, 고층 뷰와 안락한 소파 테이블 구비.", amenities: ["🛏️ 더블 침대", "🪑 소파 / 테이블", "📺 스마트TV", "❄️ 에어컨 / 드라이어"] },
    ...
    vi: [
        ...
        { floor: "4F", name: "Phòng 1401 (Đôi)", sub: "Tầng cao sang trọng, không gian yên tĩnh riêng tư.", size: "24 m²", highlight: "Cửa sổ sàn-trần", img: "/images/hellohouse/1401.jpg", imgAlt: "Hello House B&B Kaohsiung - 4F Phòng 1401 phòng đôi thanh lịch trên tầng cao với tầm nhìn mở và sofa thư giãn.", amenities: ["🛏️ Giường đôi", "🪑 Sofa / Bàn", "📺 Smart TV", "❄️ Điều hòa / Máy sấy"] },
                    ...
                    <Reveal>
                        <div className="grid-asym" style={{ marginBottom: "0" }}>
                            <div className="img-zoom img-rounded" style={{ aspectRatio: "4/3" }}>
                                <Image src="/images/hellohouse/photo1.jpg" alt="Hello House B&B Kaohsiung - Private townhouse B&B accommodating 6 to 26 guests with premium open kitchen, mahjong, and smart TV." width={700} height={525} sizes="(max-width: 768px) 100vw, 50vw" className="img-cover" />
                            </div>
                            <div>
