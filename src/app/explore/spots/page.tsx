...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.hello-stay.com/images/explore/pier2.webp", width: 1280, height: 853, alt: "駁二藝術特區蓬萊倉庫群" }],
  },
};
  ...
  return (
    <>
      ...
      <LocalGuidePage
        ...
        image={{ src: "/images/explore/pier2.webp", alt: "駁二藝術特區蓬萊倉庫群與周邊景點" }}
        facts={[
