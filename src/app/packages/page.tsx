...
export const metadata: Metadata = {
    title: "高雄包棟民宿方案 | 企業・婚禮・家族・球隊・派對 | Hello Stay",
    description: "專為各種場合量身打造的高雄包棟住宿方案｜企業移地訓練、婚禮迎娶、家族旅遊、球隊比賽、朋友派對，鹽埕區最彈性的包棟民宿。6-48人多種組合，平日週末透明定價，LINE AI管家即時報價。",
    alternates: { canonical: "https://www.hello-stay.com/packages" },
    openGraph: {
        title: "高雄包棟民宿方案 | 企業・婚禮・家族・球隊 | Hello Stay",
...
const packages = [
    ...
    },
    {
        ...
        features: ["麻將（長輩最愛）", "大型中島廚房", "分層住宿互不干擾", "適合三代同堂"],
        color: "#F59E0B",
    },
    {
        emoji: "⚽",
    ...
    },
    {
        ...
        features: ["桌遊同樂設備", "私密不受干擾", "附近酒吧散步到", "麻將打到天亮"],
        color: "#8B5CF6",
    },
    {
        emoji: "🍜",
