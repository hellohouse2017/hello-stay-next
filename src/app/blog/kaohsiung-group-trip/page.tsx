        ...
        plans: [
            {
                ...
                day2: "打狗英國領事館（俯瞰西子灣）→ 旗津渡輪 → 旗津老街午餐 → 旗津燈塔咖啡廳 → 回民宿 KTV 歡唱 → 空白酒吧",
        ...
        plans: [
            {
                ...
                day3: "駁二全日（倉庫群→大港橋→棧貳庫→流行音樂中心）→ 民宿 KTV 之夜",
        ...
        <div style={{ paddingTop: "calc(var(--nav-h) + 40px)", background: "#FAF8F5", minHeight: "100vh" }}>
            <JsonLd data={[
                ...
                },
                {
                    ...
                    mainEntity: [
                        { "@type": "Question", name: "高雄團體旅遊住哪裡好？", acceptedAnswer: { "@type": "Answer", text: "推薦住鹽埕區的包棟民宿，如Hello Stay你好哇寓所。步行可達駁二、大港橋，附近30+間美食老店。包棟有廚房、麻將、KTV，晚上不用出門也能玩。6-48人彈性方案。" } },
                        ...
                        { "@type": "Question", name: "高雄3天2夜行程推薦？", acceptedAnswer: { "@type": "Answer", text: "推薦文化慢旅路線：Day1鹽埕老街→愛河貢多拉。Day2打狗英國領事館→旗津渡輪→燈塔咖啡廳→民宿KTV。Day3衛武營藝術中心。住在鹽埕區的包棟民宿，景點全在步行或捷運範圍內。" } },
                    ],
                },
            ]} />
