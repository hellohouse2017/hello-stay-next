...
const articles = [
    ...
    { slug: "kaohsiung-graduation-trip", title: "高雄畢業旅行包棟推薦｜學生畢旅住宿首選", excerpt: "20人平均每人不到$1,000！有KTV、麻將桌、廚房。3天2夜全攻略。", date: "2026-03-06", emoji: "🎓", tags: ["畢旅", "學生"] },
    ...
    { slug: "kaohsiung-nye-stay", title: "高雄跨年包棟推薦｜倒數派對・煙火觀賞", excerpt: "中島廚房跨年大餐，KTV倒數歡唱，步行到港邊看煙火。", date: "2026-03-06", emoji: "🎆", tags: ["跨年", "派對"] },
    { slug: "kaohsiung-mahjong-stay", title: "高雄麻將民宿推薦｜自動麻將桌・打牌到天亮", excerpt: "自動麻將桌免洗牌，不限時打到凌晨。邊打邊煮宵夜。", date: "2026-03-06", emoji: "🀄", tags: ["麻將", "娛樂"] },
    ...
    { slug: "kaohsiung-ktv-party", title: "高雄 KTV 派對包棟推薦｜歡唱不限時・生日趴", excerpt: "不限時KTV免費使用，搭配廚房和麻將桌。生日派對首選。", date: "2026-03-06", emoji: "🎤", tags: ["KTV", "派對"] },
    ...
    { slug: "kaohsiung-sports-team", title: "高雄球隊比賽住宿推薦｜系隊・社會隊包棟", excerpt: "製冰機冰敷、洗衣機洗球衣、廚房補充營養。10-38人包棟。", date: "2026-03-06", emoji: "⚾", tags: ["球隊", "比賽"] },
];
