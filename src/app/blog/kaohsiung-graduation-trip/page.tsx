...
export const metadata: Metadata = {
    ...
    description: "高雄畢旅住包棟民宿最划算！20人平均每人不到$1,000，有KTV、麻將桌、廚房可煮宵夜。走路到駁二，捷運到西子灣旗津。",
...
23:00 後降低音量，位於住宅區。KTV 11 點前盡量唱完。
    ...
    return (
        <div style={{ paddingTop: "calc(var(--nav-h) + 40px)", background: "#FAF8F5", minHeight: "100vh" }}>
            <JsonLd data={[
                { "@context": "https://schema.org", "@type": "Article", headline: "高雄畢業旅行包棟推薦", author: { "@type": "Organization", name: "Hello Stay" }, publisher: { "@type": "Organization", name: "Hello Stay" }, datePublished: "2026-03-06", mainEntityOfPage: "https://www.hello-stay.com/blog/kaohsiung-graduation-trip", speakable: { "@type": "SpeakableSpecification", cssSelector: ["h1", "#why", "#plan"] } },
                {
                    "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
                        { "@type": "Question", name: "高雄畢業旅行住哪裡便宜又好玩？", acceptedAnswer: { "@type": "Answer", text: "推薦你好哇寓所包棟民宿，20人每人不到$1,000/晚。有KTV、麻將桌、廚房可煮宵夜。走路10分鐘到駁二，捷運可到旗津、西子灣。3天2夜含交通住宿餐費每人約$4,000-$4,500。" } },
                        { "@type": "Question", name: "高雄畢旅3天2夜行程怎麼排？", acceptedAnswer: { "@type": "Answer", text: "Day1：駁二+大港橋+KTV之夜。Day2：旗津一日遊+中島廚房火鍋趴。Day3：棧貳庫+伴手禮。住包棟民宿，晚上不用趕回飯店，想玩到多晚都可以。" } },
                    ]
                },
            ]} />
            <div className="w" style={{ maxWidth: "720px", padding: "0 28px 80px" }}>
                ...
                <Reveal><div style={{ marginBottom: "40px" }}><div style={{ fontFamily: "var(--en)", fontSize: "0.65rem", letterSpacing: "0.2em", color: "#C8AD7F", marginBottom: "12px" }}>2026-03-06</div><h1 style={{ fontFamily: "var(--serif)", fontSize: "clamp(1.4rem, 4vw, 2rem)", fontWeight: 400, letterSpacing: "0.04em", color: "#2a2a2a", lineHeight: 1.6 }}>高雄畢業旅行包棟推薦<br />學生畢旅・班遊住宿首選</h1><div style={{ width: "40px", height: "1px", background: "#C8AD7F", margin: "20px 0" }} /></div></Reveal>
