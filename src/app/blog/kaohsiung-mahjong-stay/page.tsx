...
• ` },
    {
        id: "setup", title: "你好哇寓所的麻將配備", content: `麻將
• 品牌：傳統手動麻將
• 位置：4F 交誼廳（你好哇）/ 4F（溝頂）
• 桌布：絨面，牌感一流
• 檯面大小：標準尺寸，舒適打牌
    ...
    return (
        <div style={{ paddingTop: "calc(var(--nav-h) + 40px)", background: "#FAF8F5", minHeight: "100vh" }}>
            <JsonLd data={[
                { "@context": "https://schema.org", "@type": "Article", headline: "高雄麻將民宿推薦", author: { "@type": "Organization", name: "Hello Stay" }, publisher: { "@type": "Organization", name: "Hello Stay" }, datePublished: "2026-03-06", mainEntityOfPage: "https://www.hello-stay.com/blog/kaohsiung-mahjong-stay", speakable: { "@type": "SpeakableSpecification", cssSelector: ["h1", "#why", "#setup"] } },
                {
                    "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
                        { "@type": "Question", name: "高雄有麻將的民宿推薦？", acceptedAnswer: { "@type": "Answer", text: "你好哇寓所和溝頂民宿都有麻將。位於4F交誼廳，獨立空調照明。可打到凌晨不限時，打累了上樓直接睡。附近有阿囉哈滷味、鹹酥雞當宵夜，中島廚房也能自煮火鍋。6-26人包棟。" } },
                        { "@type": "Question", name: "高雄包棟民宿可以打麻將到幾點？", acceptedAnswer: { "@type": "Answer", text: "包棟民宿打麻將不限時，凌晨也可以。但23:00後請降低音量，避免碰胡大叫。麻將噪音不大，主要是人聲要控制。" } },
                    ]
                },
            ]} />
            <div className="w" style={{ maxWidth: "720px", padding: "0 28px 80px" }}>
                ...
                <Reveal><div style={{ marginBottom: "40px" }}><div style={{ fontFamily: "var(--en)", fontSize: "0.65rem", letterSpacing: "0.2em", color: "#C8AD7F", marginBottom: "12px" }}>2026-03-06</div><h1 style={{ fontFamily: "var(--serif)", fontSize: "clamp(1.4rem, 4vw, 2rem)", fontWeight: 400, letterSpacing: "0.04em", color: "#2a2a2a", lineHeight: 1.6 }}>高雄麻將民宿推薦<br />麻將・打牌到天亮</h1><div style={{ width: "40px", height: "1px", background: "#C8AD7F", margin: "20px 0" }} /></div></Reveal>
