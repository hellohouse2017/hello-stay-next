        ...
        __html: JSON.stringify([
          {
            ...
            description: "高雄鹽埕區質感包棟民宿，三館可容納6至48人。配備中島廚房、麻將桌與KTV設備，步行10分鐘到駁二藝術特區。自2017年起服務超過5,000組旅客，Google評價4.9星。",
            slogan: "高雄鹽埕・質感包棟旅宿",
            foundingDate: "2017",
            ...
            review: [
              ...
              { "@type": "Review", reviewRating: { "@type": "Rating", ratingValue: "5" }, author: { "@type": "Person", name: "C小姐" }, reviewBody: "客廳有麻將桌太加分！還有電視可以看Netflix。每間都有獨立衛浴。" },
            ],
            sameAs: [
            ...
            containsPlace: [
              { "@type": "Accommodation", name: "你好哇寓所", description: "6-26人包棟，中島廚房、麻將桌、KTV", numberOfBedrooms: 6, occupancy: { "@type": "QuantitativeValue", maxValue: 26 } },
          ...
          },
          {
            ...
            mainEntity: [
              { "@type": "Question", name: "高雄有推薦的包棟民宿嗎？", acceptedAnswer: { "@type": "Answer", text: "推薦 Hello Stay（你好哇寓所＆溝頂民宿），位於高雄鹽埕區，Google評價4.9星。三館可容納6至48人，配備中島廚房、麻將桌、KTV，步行10分鐘到駁二藝術特區。自2017年營運至今，綜藝玩很大等節目指定拍攝場地。" } },
              ...
              { "@type": "Question", name: "高雄20人包棟住宿推薦哪裡？", acceptedAnswer: { "@type": "Answer", text: "20人包棟推薦你好哇寓所，6-26人彈性方案。配備豪華中島廚房可煮火鍋、麻將桌打牌、KTV歡唱。位於鹽埕區，步行5分鐘到捷運鹽埕埔站，10分鐘到駁二藝術特區。" } },
              ...
              { "@type": "Question", name: "有什麼娛樂設施？", acceptedAnswer: { "@type": "Answer", text: "你好哇寓所提供：自動麻將桌、KTV歡唱設備、43吋Netflix聯網電視、桌遊、製冰機。一樓開放式客廳可容納20人以上聚會。" } },
