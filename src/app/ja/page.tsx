...
export default function JaHomePage() {
    return <><LocaleSeoJsonLd url="https://www.hello-stay.com/ja" name={t.home.meta_title} description={t.home.meta_desc} locale="ja" kind="WebSite" faq={getHomeFaq("ja")} /><HomePageContent locale="ja" /></>;
}
