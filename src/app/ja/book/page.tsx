...
export const metadata: Metadata = {
    ...
    alternates: { canonical: "https://www.hello-stay.com/ja/book", languages: getAlternateLanguageMap("/book") },
};

export default function JaBookPage() {
    return <><LocaleSeoJsonLd url="https://www.hello-stay.com/ja/book" name={t.book.meta_title} description={t.book.meta_desc} locale="ja" /><BookingFlow /></>;
}
