...
export const metadata: Metadata = {
    ...
    alternates: { canonical: "https://www.hello-stay.com/ja/guide", languages: getAlternateLanguageMap("/guide") },
    openGraph: {
        title: t.guide.meta_title,
        description: t.guide.meta_desc,
        url: "https://www.hello-stay.com/ja/guide",
        type: "website",
    },
};

export default function JaGuidePage() {
    return <GuidePageContent locale="ja" />;
}
