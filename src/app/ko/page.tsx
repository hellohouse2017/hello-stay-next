...
export default function KoHomePage() {
    return <><LocaleSeoJsonLd url="https://www.hello-stay.com/ko" name={t.home.meta_title} description={t.home.meta_desc} locale="ko" kind="WebSite" faq={getHomeFaq("ko")} /><HomePageContent locale="ko" /></>;
}
