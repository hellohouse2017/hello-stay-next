        ...
        <div style={{ paddingTop: "calc(var(--nav-h) + 40px)", background: "var(--bg)", minHeight: "100vh" }}>
            <JsonLd data={{
                ...
                mainEntity: [
                    ...
                    { "@type": "Question", name: "你好哇寓所和溝頂有什麼不同？", acceptedAnswer: { "@type": "Answer", text: "你好哇：3層樓6間房，豪華中島廚房+全自動麻將桌，適合聚會；溝頂：5層獨棟4間房，每層獨立空間，適合小家庭和帶長輩旅遊。" } },
                ],
            }} />
