...
export const metadata: Metadata = {
  title: "高雄包棟民宿比較｜4房/6房/10房全套房對照・中島廚房與麻將怎麼選",
  description:
    "高雄包棟民宿完整比較：溝頂民宿（4房/4衛・4-12人）、你好哇寓所（6房/6衛・8-26人）與雙館 10 房方案。橫向對比分房隱私、中島廚房、麻將設備與即時房價，快速選出最適合館別。",
  alternates: { canonical: "https://www.hello-stay.com/compare" },
  openGraph: {
    title: "高雄包棟民宿比較｜4房/6房/10房全套房對照・中島廚房與麻將怎麼選 | Hello Stay",
    description: "高雄包棟民宿完整比較：溝頂民宿（4房/4衛・4-12人）、你好哇寓所（6房/6衛・8-26人）與雙館 10 房方案。橫向對比分房隱私、中島廚房、麻將設備與即時房價，快速選出最適合館別。",
...
const comparisonFacts = [
  { label: "4 房包棟（4-12人）", value: "溝頂：4 間客房皆有獨立衛浴・整棟獨享" },
  { label: "6 房包棟（8-26人）", value: "你好哇：6 間客房皆有獨立衛浴＋中島大廚房" },
  { label: "10 房包棟（27-36人）", value: "雙館：10 間客房皆有獨立衛浴・分棟休息" },
  { label: "分房隱私與承諾", value: "每間客房皆有獨立衛浴・整棟專屬獨享" },
];

const bookingNotes = [
  "3-4 對情侶或小家庭：溝頂 4 房提供 4 間客房（2雙+2四），每間皆有專屬衛浴",
  "多組家庭或聚會迎娶：你好哇 6 房提供 6 間獨立衛浴客房與 1F 中島廚房大客廳",
  "包棟透明承諾：所有包棟方案皆享有完整房間數與專屬整棟空間，一組客人包全棟",
  ...
  return (
    <>
      ...
      <PropertyShowcasePage
        hero={{
          kicker: "比較 4 房・6 房・10 房",
          title: "比較 4 房、6 房與 10 房，快速決定高雄包棟怎麼選",
          lead: [
            "這一頁專門比較分房隱私、中島廚房與公共空間。",
            "已經知道人數？直接前往高雄包棟主頁依 4–12、8–26 或 27–36 人選館查房；還在比較配置，就看本頁完整表格。",
          ],
          image: {
